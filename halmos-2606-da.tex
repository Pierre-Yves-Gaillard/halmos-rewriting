...
Here is a rewriting\footnote{This text is available at \url{https://github.com/Pierre-Yves-Gaillard/halmos-rewriting}} of some proofs from Halmos's wonderful book titled \textbf{Naive Set Theory} \cite{halmos_naive_1974}. Here is a more precise formulation: 
